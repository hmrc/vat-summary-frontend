...
// Parent charge: Main transaction: 4625 Sub transaction: 1176
case object VatReturn2ndLPPRPI extends ChargeType {
  override val value: String = "VAT Return 2nd LPP RPI"
}

// Parent charge: Main transaction: 4629 Sub transaction: 1176
case object VatReturnPOA1stLPPRPI extends ChargeType {
  override val value: String = "VAT Return POA 1st LPP RPI"
}

// Parent charge: Main transaction: 4631 Sub transaction: 1176
case object VatReturnPOA2ndLPPRPI extends ChargeType {
  override val value: String = "VAT Return POA 2nd LPP RPI"
}

// Parent charge: Main transaction: 4635 Sub transaction: 1176
case object VatReturnAA1stLPPRPI extends ChargeType {
  override val value: String = "VAT Return AA 1st LPP RPI"
}

// Parent charge: Main transaction: 4637 Sub transaction: 1176
case object VatReturnAA2ndLPPRPI extends ChargeType {
  override val value: String = "VAT Return AA 2nd LPP RPI"
}

// Parent charges: Main transaction 4731, Sub transaction 1174
...
// Parent charge: Main transaction 4720, Sub transaction 1174
case object VatCentralAssessRPI extends ChargeType {
  override val value: String = "VAT Central Assessment RPI"
}

// Parent charge: Main transaction 4723, Sub transaction 1090
case object VatCa1stLppRPI extends ChargeType {
  override val value: String = "VAT CA 1st LPP RPI"
}

// Parent charge: Main transaction 4744, Sub transaction 1090
...
// Parent charge: Main transaction: 4743, Sub transaction 1090
case object VatErrorCorrect1stLppRPI extends ChargeType {
  override val value: String = "VAT Error Correct 1st LPP RPI"
}

// Parent charge: Main transaction: 4748, Sub transaction 1090
case object VatLspRepaymentInterest extends ChargeType {
  override val value: String = "VAT LSP Repayment Interest"
}

// Parent charge: Main transaction: 4724, Sub transaction 1090
case object VatCa2ndLppRPI extends ChargeType {
...
// Parent charge: Main transaction: 4758, Sub transaction 1090
case object VatAA1stLppRPI extends ChargeType {
  override val value: String = "VAT AA 1st LPP RPI"
}

// Parent charge: Main transaction: 4759, Sub transaction 1090
case object VatAA2ndLppRPI extends ChargeType {
  override val value: String = "VAT AA 2nd LPP RPI"
}

// Parent charge: Main transaction: 4761, Sub transaction 1090
case object VatPA1stLppRPI extends ChargeType {
  override val value: String = "VAT PA 1st LPP RPI"
}

// Parent charge: Main transaction: 4762, Sub transaction 1090
case object VatPA2ndLppRPI extends ChargeType {
  override val value: String = "VAT PA 2nd LPP RPI"
}
