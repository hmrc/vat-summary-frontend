...
case class TransactionSubItem(clearingSAPDocument: Option[String],
...
object TransactionSubItem {
  ...
  implicit val reads: Reads[TransactionSubItem] = (
    (JsPath \ FinancialTransactionsConstants.clearingSAPDocument).readNullable[String] and
    (JsPath \ FinancialTransactionsConstants.amount).readNullable[BigDecimal] and
