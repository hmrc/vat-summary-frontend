...
@Singleton
class StandingRequestsConnector @Inject()(http: HttpClient, appConfig: AppConfig) extends LoggerUtil {

  private[connectors] def standingRequestsUrl(regime: String, taxpayerIdType: String, taxpayerIdValue: String): String =
    s"${appConfig.etmpBaseUrl}/RESTAdapter/$regime/standing-requests/$taxpayerIdType/$taxpayerIdValue"
