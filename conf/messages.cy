...
whatYouOwe.ifYouCannotPayThree = trefnu cynllun talu (yn agor tab newydd)
...
estimatedInterest.currentRate = ???
estimatedInterest.rateChanges = Os bydd y gyfradd llog yn newid yn ystod y cyfnod y mae’r llog yn cronni, byddwn yn defnyddio’r hen gyfradd llog hyd at y dyddiad y bydd y gyfradd llog yn newid, ac yna’n defnyddio’r un newydd ar ôl hynny. Gallwch
estimatedInterest.prevIntRateLink = ddod o hyd i gyfraddau llog blaenorol ar GOV.UK (yn agor tab newydd).
