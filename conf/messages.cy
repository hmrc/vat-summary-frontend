...
estimatedInterest.youCan = Gallwch
estimatedInterest.prevIntRateLink = ddod o hyd i gyfraddau llog ar GOV.UK (yn agor tab newydd)
estimatedInterest.penaltyCalculation = (Cyfradd llog × swm y gosb sydd heb ei thalu) ÷ nifer y diwrnodau mewn blwyddyn
...
crystallisedInterest.youCan = Gallwch
crystallisedInterest.prevIntRateLink = ddod o hyd i gyfraddau llog ar GOV.UK (yn agor tab newydd)
