...
chargeType.VatAdditionalAssessmentDescription = yn seiliedig ar wybodaeth bellach ar gyfer y cyfnod {0}
...
chargeType.vatProtectiveAssessmentChargeDescription = a godir er mwyn diogelu sefyllfa CThEM yn ystod apêl
