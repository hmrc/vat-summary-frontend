...
whatYouOwe.anyPaymentsYouMake = O ran unrhyw daliadau a wnewch:
whatYouOwe.agent.anyPaymentsYouMake = O ran unrhyw daliadau a wneir gan eich cleient:
whatYouOwe.anyPaymentsYouMake.firstBullet = gall cymryd hyd at 5 diwrnod gwaith i’w prosesu, yn dibynnu ar
whatYouOwe.anyPaymentsYouMake.firstBulletLink = y dull talu rydych yn ei ddefnyddio (yn agor tab newydd)
whatYouOwe.anyPaymentsYouMake.agent.firstBulletLink = y dull talu mae’ch cleient yn ei ddefnyddio (yn agor tab newydd)
whatYouOwe.anyPaymentsYouMake.secondBullet = mae’n rhaid iddynt ein cyrraedd erbyn y dyddiad cau – os bydd eich taliad yn hwyr, codir llog arnoch ac efallai y bydd yn rhaid i chi dalu cosb
whatYouOwe.anyPaymentsYouMake.agent.secondBullet = ein cyrraedd erbyn y dyddiad dyledus – os bydd taliad eich cleient yn hwyr, codir llog arno ac efallai y bydd yn rhaid iddo dalu cosb
whatYouOwe.makePayment = Talu nawr
whatYouOwe.ifYouCannotPayOne = Os na allwch dalu heddiw
whatYouOwe.ifYouCannotPayTwo = Os na allwch dalu bil treth, gallwch ofyn i CThEM am
whatYouOwe.ifYouCannotPayThree = sefydlu Trefniant Amser i Dalu (yn agor tab newydd)
...
whatYouOwe.details.agent.paymentHelpTwo = Os na all eich cleient dalu bil treth, gall ofyn i CThEM am
whatYouOwe.details.agent.paymentHelpThree = sefydlu Trefniant Amser i Dalu (yn agor tab newydd)
whatYouOwe.details.agent.paymentHelpFour = Mae hyn yn ei alluogi i dalu’i fil fesul rhandaliad.
