...
class ObligationsSpec extends UnitSpec {
  ...
  "An obligation" should {
    ...
    "parse from json" in {
      ...
      val result = Json.parse(input).as[Obligation]
  ...
  "Obligations" should {
    ...
    "parse from json" in {
      ...
      val result = Json.parse(input).as[Obligations]
