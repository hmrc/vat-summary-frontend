...
class PaymentsHistoryChargeDescriptionTemplateSpec extends ViewBaseSpec with TableDrivenPropertyChecks {
  ...
  private val nonAgentChargeTable = Table(
    ...
    (VatDefaultInterestDebit, "Default interest", "based on our assessment of tax for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "based on our assessment of tax for the period 12 Jan to 23 Mar 2018"),
    (VatDefaultInterestCredit, "Default interest", "based on our assessment of tax for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "based on our assessment of tax for the period 12 Jan to 23 Mar 2018"),
    (VatFurtherInterestDebit, "Further interest", "based on our assessment of tax for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "based on our assessment of tax for the period 12 Jan to 23 Mar 2018"),
    (VatFurtherInterestCredit, "Further interest", "based on our assessment of tax for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "based on our assessment of tax for the period 12 Jan to 23 Mar 2018"),
    (VatRepaymentSupplementRecovery, "Repayment supplement recovery", "to recover the amount overpaid by HMRC",
      "to recover the amount overpaid by HMRC"),
    (VatIndirectTaxRevenueRecovery, "Payment recovery", "Payment recovery", "to recover a payment made in error by HMRC"),
    (RepaymentSupplement, "Late repayment compensation from HMRC", "we took too long to repay the 12\u00a0Jan to 23\u00a0Mar\u00a02018 return",
        "we took too long to repay the 12 Jan to 23 Mar 2018 return"),
    (BnpRegPre2010Charge, "Penalty for late registration", "because you should have been registered for VAT earlier",
      "because you should have been registered for VAT earlier"),
    (BnpRegPost2010Charge, "Penalty for late registration", "because you should have been registered for VAT earlier",
        "because you should have been registered for VAT earlier"),
    (FtnMatPre2010Charge, "Failure to notify penalty", "because you did not tell us you are no longer exempt from VAT registration",
        "because you did not tell us you are no longer exempt from VAT registration"),
    (MiscPenaltyCharge, "VAT general penalty", "", ""),
    (VatOAInaccuraciesFrom2009, "Inaccuracies penalty", "because you submitted an inaccurate document for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
        "because you submitted an inaccurate document for the period 12 Jan to 23 Mar 2018"),
    (VatCarterPenaltyLPI, "Interest on penalty for not filing correctly", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
                "for period 12 Jan to 23 Mar 2018"),
    (FailureToNotifyRCSLCharge, "Failure to notify penalty",
        "because you failed to notify us of the date you made a reverse charge sale or stopped making supplies",
        "because you failed to notify us of the date you made a reverse charge sale or stopped making supplies"),
    (VatInaccuraciesInECSalesCharge, "Inaccuracies penalty",
        "because you have provided inaccurate information in your EC sales list",
        "because you have provided inaccurate information in your EC sales list"),
    (VatPADefaultInterestCharge, "Protective assessment default interest", "charged on the protective assessment",
        "charged on the protective assessment"),
    (VatProtectiveAssessmentCharge, "Protective assessment of VAT", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
    (VatSecurityDepositRequestCharge, "Security deposit requirement", "because you have not paid VAT in your current business or a previous business",
        "because you have not paid VAT in your current business or a previous business"),
    (VatECFurtherInterestCharge, "Error correction further interest", "charged on assessed amount", "charged on assessed amount"),
    (VatECDefaultInterestCharge, "Error correction default interest", "charged on assessed amount", "charged on assessed amount"),
    (VatPaFurtherInterestCharge, "Protective assessment further interest", "due on the protective assessment as this was not paid on time",
        "due on the protective assessment as this was not paid on time"),
    ...
    (VatPA1stLPPLPI, "Interest on protective assessment penalty",  "for 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for 12 Jan to 23 Mar 2018"),
    (VatPA2ndLPPLPI, "Interest on second penalty for protective assessment", "for 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for 12 Jan to 23 Mar 2018"),
    (VatManualLPI, "Interest on late payment of VAT", "", ""),
    (VATOverpaymentforTax, "VAT correction", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
    (VatOverpaymentForRPI, "Repayment interest correction", "for 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for 12 Jan to 23 Mar 2018"),
    (VATOverpaymentforTaxLPI, "Interest on VAT correction", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
    (VatOverpayments1stLPPLPI, "Interest on VAT correction penalty", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
    (VatOverpayments2ndLPPLPI, "Interest on VAT correction second penalty", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
  ...
  private val agentChargeTable = Table(
    ...
    (RepaymentSupplement, "Late repayment compensation from HMRC", "we took too long to repay the 12\u00a0Jan to 23\u00a0Mar\u00a02018 return",
        "we took too long to repay the 12 Jan to 23 Mar 2018 return"),
    (BnpRegPre2010Charge, "Penalty for late registration", "because your client should have been registered for VAT earlier",
        "because your client should have been registered for VAT earlier"),
    (BnpRegPost2010Charge, "Penalty for late registration", "because your client should have been registered for VAT earlier",
        "because your client should have been registered for VAT earlier"),
    (FtnMatPre2010Charge, "Failure to notify penalty", "because your client did not tell us they were no longer exempt from VAT registration",
        "because your client did not tell us they were no longer exempt from VAT registration"),
    (MiscPenaltyCharge, "VAT general penalty", "", ""),
    (VatOAInaccuraciesFrom2009, "Inaccuracies penalty",
        "because your client submitted an inaccurate document for the period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
        "because your client submitted an inaccurate document for the period 12 Jan to 23 Mar 2018"),
    (FailureToNotifyRCSLCharge, "Failure to notify penalty",
        "because your client failed to notify us of the date they made a reverse charge sale or stopped making supplies",
        "because your client failed to notify us of the date they made a reverse charge sale or stopped making supplies"),
    (VatInaccuraciesInECSalesCharge, "Inaccuracies penalty",
        "because your client has provided inaccurate information in their EC sales list",
        "because your client has provided inaccurate information in their EC sales list"),
    (VatPADefaultInterestCharge, "Protective assessment default interest", "charged on the protective assessment",
        "charged on the protective assessment"),
    (VatProtectiveAssessmentCharge, "Protective assessment of VAT", "for period 12\u00a0Jan to 23\u00a0Mar\u00a02018",
      "for period 12 Jan to 23 Mar 2018"),
    (VatSecurityDepositRequestCharge, "Security deposit requirement", "because your client did not pay VAT in their current business or a previous business",
        "because your client did not pay VAT in their current business or a previous business"),
    (VatECFurtherInterestCharge, "Error correction further interest", "charged on assessed amount", "charged on assessed amount"),
    (VatECDefaultInterestCharge, "Error correction default interest", "charged on assessed amount", "charged on assessed amount"),
    (VatPaFurtherInterestCharge, "Protective assessment further interest", "due on the protective assessment as this was not paid on time",
        "due on the protective assessment as this was not paid on time"),
