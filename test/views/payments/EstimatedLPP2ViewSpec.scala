  ...
  "Rendering the Estimated LPP2 Page for a principal user" when {
    ...
    "the user has no time to pay arrangement and no breathing space" should {
      ...
      "have the correct page heading" in {
        elementWholeText(Selectors.heading) shouldBe "1\u00a0January\u00a02020 to 2\u00a0February\u00a02020 Second late payment penalty"
      }

      "have a period caption" in {
        elementWholeText(Selectors.caption) shouldBe "1\u00a0January\u00a02020 to 2\u00a0February\u00a02020"
      }
