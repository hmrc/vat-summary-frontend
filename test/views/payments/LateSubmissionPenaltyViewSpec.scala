...
class LateSubmissionPenaltyViewSpec extends ViewBaseSpec {
  ...
  "Rendering the Late Submission Penalty page for a principal user" when {
    ...
    "use a non breaking space for the page heading" in {
      viewAsString.contains("5\u00a0May\u00a02020 to 6\u00a0June\u00a02020 Late submission penalty")
    }
    ...
    "use a non breaking space for the period caption" in {
      viewAsString.contains("5\u00a0May\u00a02020 to 6\u00a0June\u00a02020")
    }
    ...
    "use a non breaking space to display when the penalty is due by" in {
      viewAsString.contains(" Due Date 1\u00a0October\u00a02020")
    }
