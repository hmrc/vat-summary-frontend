...
class LateSubmissionPenaltyViewSpec extends ViewBaseSpec {
  ...
  "Rendering the Late Submission Penalty page for a principal user" when {
    ...
    "have the correct page heading" in {
      elementWholeText("h1") shouldBe "5\u00a0May\u00a02020 to 6\u00a0June\u00a02020 Late submission penalty"
    }

    "have a period caption" in {
      elementWholeText(".govuk-caption-xl") shouldBe "5\u00a0May\u00a02020 to 6\u00a0June\u00a02020"
    }
    ...
    "display when the penalty is due by" in {
      elementWholeText(".govuk-summary-list__row:nth-child(1) > dd") shouldBe "1\u00a0October\u00a02020"
    }
    ...
    "display the amount received" in {
      elementText(".govuk-summary-list__row:nth-child(3) > dd") shouldBe s"£${lateSubmissionPenaltyModel.amountReceived.setScale(2)}"
    }
