  ...
  object PaymentMessages {
    ...
    def getMessagesForChargeType(chargeType: String, useLongDateFormat: Boolean = false): (String, String) = {
      ...
      chargeType match {
        ...
        case VatCentralAssessment.name => ("Estimate", s"for the $datePeriod return")
        case VatDebitDefaultSurcharge.name | VatCreditDefaultSurcharge.name => ("Surcharge", s"for late payment of the $datePeriod return")
        case VatErrorCorrectionDebitCharge.name => ("Error correction payment", s"for correcting the $datePeriod return")
        case VatErrorCorrectionCreditCharge.name => ("Error correction repayment from HMRC", s"for correcting the $datePeriod return")
        ...
        case VatAdditionalAssessment.name => ("Additional assessment", s"based on further information for the period $datePeriod")
        ...
        case ProtectiveAssessmentCharge.name => ("Protective assessment", "raised to protect HMRC’s position during an appeal")
