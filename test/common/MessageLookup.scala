...
object MessageLookup {
  ...
  object CovidMessages {
    val line1: String = "If you chose to defer your VAT payment as a result of coronavirus, you should play the VAT on or before 31 March 2021 if you are able to."
