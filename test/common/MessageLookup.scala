  ...
  object PaymentMessages {
    ...
    def getMessagesForChargeType(chargeType: String, useLongDateFormat: Boolean = false): (String, String) = {
      ...
      chargeType match {
        ...
        case VATErrorCorrection1stLPP.name => ("Late payment penalty", s"for $datePeriod")
        case VATErrorCorrection2ndLPP.name => ("Second late payment penalty", s"for $datePeriod")
