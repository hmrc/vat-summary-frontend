  ...
  object PaymentMessages {
    ...
    def getMessagesForChargeType(chargeType: String, useLongDateFormat: Boolean = false): (String, String) = {
      ...
      chargeType match {
        ...
        case VATCA1stLPP.name =>("Penalty for late payment of central assessment", s"for period $datePeriod")
        case VATCA2ndLPP.name =>("Second penalty for late payment of central assessment", s"for period $datePeriod")
