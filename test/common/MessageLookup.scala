  ...
  object PaymentMessages {
    ...
    def getMessagesForChargeType(chargeType: String, useLongDateFormat: Boolean = false): (String, String) = {
      ...
      chargeType match {
        ...
        case VatOfficerAssessmentCreditCharge.name => ("Officers assessment of VAT", s"for $datePeriod")
        case VatOfficerAssessmentDebitCharge.name => ("Officers assessment of VAT", s"for $datePeriod")
        ...
        case VatErrorCorrectionCreditCharge.name => ("Error correction", s"of VAT for $datePeriod")
