  ...
  object PaymentMessages {
    ...
    def getMessagesForChargeType(chargeType: String, useLongDateFormat: Boolean = false): (String, String) = {
      ...
      chargeType match {
        ...
        case VATErrorCorrectionLPI.name => ("Interest on error correction", s"for $datePeriod")
        case VATErrorCorrection1stLPP.name => ("Penalty for late payment of error correction", s"for $datePeriod")
        case VATErrorCorrection2ndLPP.name => ("Second penalty for late payment of error correction", s"for $datePeriod")
        case VATErrorCorrection1stLPPLPI.name => ("Interest on error correction penalty", s"for $datePeriod")
        case VATErrorCorrection2ndLPPLPI.name => ("Interest on error correction second penalty", s"for $datePeriod")
        ...
        case VATReturnPOA2ndLPPLPI.name => ("Interest on payment on account second penalty", s"for period $datePeriod")
        ...
        case VATOA1stLPP.name =>("Penalty for late payment of officer’s assessment", s"for $datePeriod")
        case VATOA2ndLPP.name =>("Second penalty for late payment of officer’s assessment", s"for $datePeriod")
        case VATReturnCA1stLPP.name =>("Penalty for late payment of central assessment", s"for period $datePeriod")
        case VATReturnCA2ndLPP.name =>("Second penalty for late payment of central assessment", s"for period $datePeriod")
        ...
        case VATPOAInstalLPI.name =>("Interest on payment on account instalment", s"for period $datePeriod")
        case VATAAReturnLPI.name =>("Interest on annual accounting balance", s"for period $datePeriod")
