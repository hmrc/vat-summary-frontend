...
import models.payments.{BnpRegPost2010Charge, Payment, PaymentNoPeriod, PaymentOnAccount, PaymentWithPeriod, Payments, ReturnDebitCharge}
...
object TestModels {
  ...
  val whatYouOweViewModel = WhatYouOweViewModel(
    ...
    Seq(WhatYouOweChargeModel(
      chargeDescription = "chargeType.vatReturnDebitChargeDescription",
